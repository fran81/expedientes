...
/***/ function(module, exports) {
	...
	function RoutesConfig($stateProvider, $urlRouterProvider) {
	  ...
	  $stateProvider.state('app', {
	    ...
	    views: {
	      'main@app': {
	        template: '<cuenta></cuenta>'
	      }
	    }
	  }).state('app.cuentacargar', {
	    url: '/cuenta-cargar',
	    data: {
	      auth: true
	    },
	    views: {
	      'main@app': {
	        template: '<cuenta-cargar></cuenta-cargar>'
	      }
	    }
	  }).state('app.userroles', {
	    url: '/user-roles',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cuentaCargar = __webpack_require__(18);

	var _cuenta = __webpack_require__(19);
...
/***/ function(module, exports) {
	...
	var CuentaCargarController = function () {
	  CuentaCargarController.$inject = ["$stateParams", "$state", "API"];
	  function CuentaCargarController($stateParams, $state, API) {
	    'ngInject';

	    _classCallCheck(this, CuentaCargarController);
	  ...
	  _createClass(CuentaCargarController, [{
	    key: 'save',
	  ...
	  return CuentaCargarController;
	}();

	var CuentaCargarComponent = exports.CuentaCargarComponent = {
...
/***/ function(module, exports) {
	...
	var CuentaController = function () {
	  CuentaController.$inject = ["$scope", "$state", "$compile", "DTOptionsBuilder", "DTColumnBuilder", "API"];
	  function CuentaController($scope, $state, $compile, DTOptionsBuilder, DTColumnBuilder, API) {
	    'ngInject';

	    var _this = this;

	    _classCallCheck(this, CuentaController);

	    this.API = API;
	    this.$state = $state;

	    var Cuentas = this.API.service('cuentas');

	    Cuentas.getList().then(function (response) {
	      ...
	      _this.dtColumns = [DTColumnBuilder.newColumn('id').withTitle('ID'), DTColumnBuilder.newColumn('numero').withTitle('Numero'), DTColumnBuilder.newColumn('nombre').withTitle('Nombre'), DTColumnBuilder.newColumn('activo').withTitle('Activa'), DTColumnBuilder.newColumn(null).withTitle('Actions').notSortable().renderWith(actionsHtml)];
	  ...
	  _createClass(CuentaController, [{
	    key: 'delete',
	    value: function _delete(cuentaId) {
	      var API = this.API;
	      var $state = this.$state;
	      ...
	      swal({
	        ...
	        API.one('cuentas').one('cuenta', cuentaId).remove().then(function () {
	          swal({
	            title: 'Deleted!',
	...
	var CuentaComponent = exports.CuentaComponent = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routeBodyclass = __webpack_require__(49);

	var _passwordVerify = __webpack_require__(50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _context = __webpack_require__(52);
